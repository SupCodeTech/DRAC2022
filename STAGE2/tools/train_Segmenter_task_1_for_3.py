...
def main():
    ...
    # Set up working dir to save files and logs.
    # cfg.work_dir = '/content/drive/MyDrive/work_dirs_for_task1_latest/1/MMSeg/DeepLab_Unet_for_3'

    cfg.runner.max_iters = 40
    cfg.log_config.interval = 10
    cfg.evaluation.interval = 40
