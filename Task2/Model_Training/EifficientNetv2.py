...
EfficientNetV2 = tf.keras.applications.efficientnet_v2.EfficientNetV2M(
    include_top=False,
    weights='imagenet',
    input_tensor=None,
...
conv = EfficientNetV2.layers[-1].output
conv = Dropout(0.5)(conv)
output = Flatten()(conv)
output = Dense(3, activation='softmax')(output)
model_ = Model(inputs=EfficientNetV2.input, outputs=output)
  

# 构建 checkpoint file

checkpoint_path = "./checkpoint/EfficientNetV2/EfficientNetV2.ckpt"
