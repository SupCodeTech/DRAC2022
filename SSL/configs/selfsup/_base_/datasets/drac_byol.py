...
data = dict(
    ...
    train=dict(
        ...
        data_source=dict(
            type=data_source,
            data_prefix='/content/drive/MyDrive/DRAC2022_Task1_Datasets/MM_Latest_Datasets_for_1/SSL/Task3_Original_Images_for_SSL/Training_Set_224',
            ann_file='/content/drive/MyDrive/DRAC2022_Task1_Datasets/MM_Latest_Datasets_for_1/SSL/Task3_Original_Images_for_SSL/Task_3_SSL.txt',
        ),
        num_views=[1, 1],
